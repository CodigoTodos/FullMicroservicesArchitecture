package com.brunoalves.OrderService.controller;


import com.brunoalves.OrderService.OrderServiceConfig;
...
import com.brunoalves.OrderService.service.OrderService;
    ...
    public void testWhen_GetOrder_Order_Not_Found() throws Exception {
        MvcResult mvcResult
                = mockMvc.perform(MockMvcRequestBuilders.get("/order/2")
                        .with(jwt().authorities(new SimpleGrantedAuthority("Admin")))                        .contentType(MediaType.APPLICATION_JSON_VALUE))
